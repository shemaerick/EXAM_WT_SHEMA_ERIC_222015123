...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO therapists(TherapistID, UserID, Specialization, Description) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("isss", $TherapistID, $UserID, $Specialization, $Description);
    // Set parameters and execute
    $TherapistID = $_POST['book_id'];
    $UserID = $_POST['ride_id'];
    $Specialization = $_POST['passenger_id'];
    $Description = $_POST['booking_time'];
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Therapists Details</title>
    <style>
        table {
            width: 100%;
