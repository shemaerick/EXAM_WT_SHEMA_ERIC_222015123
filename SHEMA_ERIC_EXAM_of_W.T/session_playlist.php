...
<head>
  ...
  <title>session_playlist Page</title>
  <style>
    /* Normal link */
    a {
      padding: 10px;
...
<section>
    <h1><u>session_playlist Form</u></h1>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO session_playlist(SessionID, PlaylistID) VALUES (?, ?)");
    $stmt->bind_param("is", $SessionID, $PlaylistID);
    // Set parameters and execute
    $SessionID = $_POST['book_id'];
    $PlaylistID = $_POST['ride_id'];
...
<body>
    <center><h2>Session_playlist Table</h2></center>
    <table border="3">
        <tr>
            <th>SessionID</th>
            <th>CommentID</th>
...
// Prepare SQL query to retrieve all session_playlist
$sql = "SELECT * FROM session_playlist";
$result = $connection->query($sql);
// Check if there are any session_playlist
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>
            ...
            <td><a style='padding:4px' href='delete_session_playlist.php?SessionID=$SessionID'>Delete</a></td> 
            <td><a style='padding:4px' href='update_session_playlist.php?SessionID=$SessionID'>Update</a></td> 
        </tr>";
    }
